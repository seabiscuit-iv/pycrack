...
function Menu (props : ResetFunc) {
    ...
    <div className="float-right mr-14 mt-12 ml-8 flex flex-col items-center justify-center align-middle">
      <div className="flex flex-row"> 
        <button onClick={() => {setShowLanguagePanel(!showLanguagePanel)}} className="flex items-center justify-center hover:bg-[#2b2f42] bg-[#1e212e] w-[11.5rem] h-10 font-jb-mono rounded-lg">  
          <p className="text-white text-center">Select Languages</p>
        </button>
        <div className="flex items-center justify-center hover:bg-[#2b2f42] bg-[#1e212e] w-20 h-10 ml-8 font-jb-mono rounded-lg">  
          <a href="/about/" className="text-white">About</a>
        </div>   
      </div>
      {showLanguagePanel ? 
      <div className="flex flex-col items-center pt-7 float-right mt-12 bg-[#1e212e] text-white text-center w-[18.5rem] h-[36rem] rounded-lg font-jb-mono">
